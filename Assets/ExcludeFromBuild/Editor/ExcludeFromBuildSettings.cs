...
namespace Kamgam.ExcludeFromBuild
{
    public class ExcludeFromBuildSettings : ScriptableObject
    {
        ...
        public const string _AutoDisableExcludedScenesTooltip = "[EXPERIMENTAL FEATURE] If enabled then all excluded scenes will be automatically disabled before a build.\n\n" +
            "NOTICE: Sadly this has a tendency to break the build so I would recommend to NOT use it as of now. It's under investigation.\n\n"+
            "You can call it manually before the build via: ExcludeFromBuildController.DisableExcludedScenes(). You can also call RevertDisabledScenes() afterwards to revert.";
