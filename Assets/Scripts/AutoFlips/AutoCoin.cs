...
{
    public static int ascendedAuto1 = 0;
    ...
    public static float wait = 0.17f;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        mainButtonClick1 = videoPlayer1.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if(GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto1 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer1.Play(); }
        else { newFlipScript.Flip(1); }
    ...
    IEnumerator CreatePopUpHeads()
    {
        ...
        popUpHeadsCopy.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.heads + "+" + FormatCoins(MainButtonClick.coinsPerClick * (1 + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus));
        ...
        GlobalCoins.CoinCount += MainButtonClick.coinsPerClick * (1 + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus);
        CreatingCoin = false;
    ...
    IEnumerator ChoseTailsHitTails()
    {
        ...
        popUpHeadsTails.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.tails + "+" + FormatCoins(MainButtonClick.coinsPerClick * (1 + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus));
    ...
    IEnumerator playerDidGetLucky()
    {
        ...
        luckyPopUpCopy.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.luckyCoin + "+" + FormatCoins((MainButtonClick.coinsPerClick * (1 + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus)) * 5);
        ...
        GlobalCoins.CoinCount += (MainButtonClick.coinsPerClick * (1 + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus)) * 5;
