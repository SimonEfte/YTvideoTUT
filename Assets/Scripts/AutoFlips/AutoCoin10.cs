...
public class AutoCoin10 : MonoBehaviour
{
    public static int ascendedAuto10 = 0;
    ...
    public VideoPlayer videoPlayer10;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer10.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper10.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto10 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer10.Play(); }
        else { newFlipScript.Flip(10); }
    ...
    {
        if (FlipperMute.flipperMute10 == 0)
        {
