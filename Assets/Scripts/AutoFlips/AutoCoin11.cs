...
public class AutoCoin11 : MonoBehaviour
{
    public static int ascendedAuto11 = 0;
    ...
    public VideoPlayer videoPlayer11;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer11.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper11.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto11 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer11.Play(); }
        else { newFlipScript.Flip(11); }
    ...
    {
        if (FlipperMute.flipperMute11 == 0)
        {
