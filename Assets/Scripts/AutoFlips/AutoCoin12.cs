...
public class AutoCoin12 : MonoBehaviour
{
    public static int ascendedAuto12 = 0;
    ...
    public VideoPlayer videoPlayer12;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer12.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper12.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto12 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) {   videoPlayer12.Play(); }
        else { newFlipScript.Flip(12); }
    ...
    {
        if (FlipperMute.flipperMute12 == 0)
        {
