...
public class AutoCoin13 : MonoBehaviour
{
    public static int ascendedAuto13 = 0;
    ...
    public VideoPlayer videoPlayer13;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer13.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper13.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto13 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer13.Play(); }
        else { newFlipScript.Flip(13); }
    ...
    {
        if (FlipperMute.flipperMute13 == 0)
        {
