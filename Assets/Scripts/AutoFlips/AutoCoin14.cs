...
public class AutoCoin14 : MonoBehaviour
{
    public static int ascendedAuto14 = 0;
    ...
    public VideoPlayer videoPlayer14;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer14.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper14.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto14 == 1)
        {
            CreatingCoin = true;
    ...
    { 
        if (LoadSaves.isMobileBuild == false) { videoPlayer14.Play(); }
        else { newFlipScript.Flip(14); }
    ...
    {
        if (FlipperMute.flipperMute14 == 0)
        {
