...
public class AutoCoin15 : MonoBehaviour
{
    public static int ascendedAuto15 = 0;
    ...
    public VideoPlayer videoPlayer15;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer15.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper15.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto15 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer15.Play(); }
        else { newFlipScript.Flip(15); }
