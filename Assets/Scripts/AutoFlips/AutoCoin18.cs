...
public class AutoCoin19 : MonoBehaviour
{
    ...
    public VideoPlayer videoPlayer19;
    public GameObject coinFlipper19;
    public GameObject transformPopUp;
    public static int ascendedAuto18 = 0;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        mainButtonClick1 = videoPlayer19.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper19.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto18 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) {    videoPlayer19.Play(); }
        else { newFlipScript.Flip(19); }
    ...
    {
        if (FlipperMute.flipperMute18 == 0)
        {
