...
public class AutoCoin18 : MonoBehaviour
{
    ...
    public VideoPlayer videoPlayer18;
    public GameObject coinFlipper18;
    public GameObject transformPopUp;
    public static int ascendedAuto19 = 0;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        mainButtonClick1 = videoPlayer18.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper18.GetComponent<MainButtonClick>();
    ...
    void Update()
    {
        ...
        if (CreatingCoin == false && ascendedAuto19 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer18.Play(); }
        else { newFlipScript.Flip(18); }
    ...
    IEnumerator playerDidGetLucky()
    {
        ...
        GlobalCoins.CoinCount += MainButtonClick.coinsPerClick * (5 + AscendScreen.luckyCoinMiltiplier);
    ...
    {
        if (FlipperMute.flipperMute19 == 0)
        {
