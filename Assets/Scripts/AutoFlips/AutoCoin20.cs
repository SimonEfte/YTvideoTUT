...
public class AutoCoin20 : MonoBehaviour
{
    public static int ascendedAuto20 = 0;
    ...
    public VideoPlayer videoPlayer20;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer20.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper20.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto20 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer20.Play(); }
        else { newFlipScript.Flip(20); }
    ...
    {
        if (FlipperMute.flipperMute20 == 0)
        {
