...
public class AutoCoin21 : MonoBehaviour
{
    public static int ascendedAuto21 = 0;
    ...
    public VideoPlayer videoPlayer21;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer21.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper21.GetComponent<MainButtonClick>();
    ...
    void Update()
    {
        ...
        if (CreatingCoin == false && ascendedAuto21 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer21.Play(); }
        else { newFlipScript.Flip(21); }
    ...
    {
        if (FlipperMute.flipperMute21 == 0)
        {
