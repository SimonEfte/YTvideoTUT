...
public class AutoCoin4 : MonoBehaviour
{
    public static int ascendedAuto4 = 0;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer4.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper4.GetComponent<MainButtonClick>();
    }

    void Update()
    {
        if (GlobalCoinMaker.coinsPerFlipUpgrades == 0) { CreatingCoin = false; }
        if (CreatingCoin == false && ascendedAuto4 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer4.Play(); }
        else { newFlipScript.Flip(4); }
    ...
    IEnumerator CreatePopUpHeads()
    {
        ...
        popUpHeadsCopy.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.heads + "+" + FormatCoins(MainButtonClick.coinsPerClick * (1 + ManualClicking.flipAllBonus));
        ...
        GlobalCoins.CoinCount += MainButtonClick.coinsPerClick * (1 + ManualClicking.flipAllBonus);
        CreatingCoin = false;
    ...
    IEnumerator ChoseTailsHitTails()
    {
        ...
        popUpHeadsTails.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.tails + "+" + FormatCoins(MainButtonClick.coinsPerClick * (1 + ManualClicking.flipAllBonus));
    ...
    IEnumerator playerDidGetLucky()
    {
        ...
        luckyPopUpCopy.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.luckyCoin + "+" + FormatCoins(MainButtonClick.coinsPerClick * (5));
        ...
        GlobalCoins.CoinCount += MainButtonClick.coinsPerClick * (5);
