...
public class AutoCoin9 : MonoBehaviour
{
    public static int ascendedAuto9 = 0;
    ...
    public VideoPlayer videoPlayer9;
    ...
    public void Awake()
    {
        mainButtonClick1 = videoPlayer9.GetComponent<MainButtonClick>();
        mainButtonClick1 = coinFlipper9.GetComponent<MainButtonClick>();
    ...
    void Update()
    {
        ...
        if (CreatingCoin == false && ascendedAuto9 == 1)
        {
            CreatingCoin = true;
    ...
    {
        if (LoadSaves.isMobileBuild == false) { videoPlayer9.Play(); }
        else { newFlipScript.Flip(9); }
