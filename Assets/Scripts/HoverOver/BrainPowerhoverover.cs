...
public class BrainPowerhoverover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Update()
    {
        if (BrainPower.currentCoins >= BrainPower.brainPowerCost)
        {
            textPrice.color = Color.green;

            textPrice.text = FormatCoins(BrainPower.brainPowerCost);
    ...
    public void SetFrame()
    {
        ...
        if (PurchaseLog.brainPowerPlussAmount >= 1000000)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.brainPowerPlussAmount / 1000000D).ToString("0.##") + LocalizationStrings.plussMillionCoins;
        }
        else if (PurchaseLog.brainPowerPlussAmount >= 1000)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.brainPowerPlussAmount / 1000D).ToString("0.##") + LocalizationStrings.plussthousandCoins;
        }
