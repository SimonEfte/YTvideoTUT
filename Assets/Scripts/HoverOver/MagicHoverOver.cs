...
public class MagicHoverOver : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Update()
    {
        if (MagicFlipsUpgrade.currentCoins >= MagicFlipsUpgrade.magicUpgradeCost)
        {
            textPrice.color = Color.green;

            textPrice.text = FormatCoins(MagicFlipsUpgrade.magicUpgradeCost);
    ...
    public void SetFrame()
    {
        ...
        if (PurchaseLog.magicFlipsPluss >= 1000000000000000000)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.magicFlipsPluss / 1000000000000000000D).ToString("0.##") + LocalizationStrings.plussQuintillionCoins;
        }
        else if (PurchaseLog.magicFlipsPluss >= 1000000000000000)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.magicFlipsPluss / 1000000000000000D).ToString("0.##") + LocalizationStrings.plussQuadrillionCoins;
        }
