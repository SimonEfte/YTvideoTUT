...
public class RitualHover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Update()
    {
        textPrice.text = FormatCoins(RitualUpgrade.ritualCost);
       

        if (RitualUpgrade.currentCoins >= RitualUpgrade.ritualCost)
        {
    ...
    public void SetFrame()
    {
        ...
        if (PurchaseLog.ritualPluss >= 1000000000000000000000000f)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.ritualPluss / 1000000000000000000000000D).ToString("0.##") + LocalizationStrings.plussSeptillionCoins;
        }
        else if (PurchaseLog.ritualPluss >= 1000000000000000000000f)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.ritualPluss / 1000000000000000000000D).ToString("0.##") + LocalizationStrings.plussSextillionCoins;
        }
