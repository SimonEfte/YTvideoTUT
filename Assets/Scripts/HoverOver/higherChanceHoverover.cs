...
public class higherChanceHoverover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public static float headsPercent = 49.75f;
    public static float tailsPercent = 49.75f;
    ...
    void Update()
    {
        ...
        {
            if (HigherChance.currentCoins >= HigherChance.higherChanceValue)
            {
                textPrice.color = Color.green;
                textPrice.text = FormatCoins(HigherChance.higherChanceValue);
