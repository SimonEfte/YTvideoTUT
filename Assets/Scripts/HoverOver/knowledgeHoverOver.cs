...
public class knowledgeHoverOver : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Update()
    {
        if (KnowledgeUpgrade.currentCoins >= KnowledgeUpgrade.knowledgeClickValue)
        {
            textPrice.color = Color.green;

            textPrice.text = FormatCoins(KnowledgeUpgrade.knowledgeClickValue);
    ...
    public void SetFrame()
    {
        ...
        textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + PurchaseLog.knowledgePlussAmount + LocalizationStrings.plussCoins;
    }
