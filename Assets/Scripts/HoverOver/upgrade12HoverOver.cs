...
public class upgrade12HoverOver : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void Update()
    {
        if (Upgrade12.currentCoins >= Upgrade12.upgrade12Cost)
        {
            textPrice.color = Color.green;
            textPrice.text = FormatCoins(Upgrade12.upgrade12Cost);
    ...
    public void SetFrame()
    {
        ...
        if (PurchaseLog.upgrade12Pluss >= 1000000000000000)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.upgrade12Pluss / 1000000000000000D).ToString("0.##") + LocalizationStrings.plussQuadrillionCoins;
        }
        else if (PurchaseLog.upgrade12Pluss >= 1000000000000)
        {
            textPlussAmount.GetComponent<TextMeshProUGUI>().text = "+" + (PurchaseLog.upgrade12Pluss / 1000000000000D).ToString("0.##") + LocalizationStrings.plussTrillionCoins;
        }
