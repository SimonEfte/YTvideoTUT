...
public class SpecialAuto1 : MonoBehaviour
{
    ...
    public GameObject coverOver1;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim1.GetComponent<GoldenFlipsButton>();
        coverOver1.SetActive(false);
    }
    ...
    public void CreateTheCoin()
    {
        ...
        {
            MainButtonClick.chall3CompletedBonus = 5;
        }
        ...
        if (EnterText.choseHeads == 1)
        {
            ...
            {
                if (random > MainButtonClick.lowSpecialChance) { StartCoroutine(CreatePopUpHeads()); }
                if (random <= MainButtonClick.lowSpecialChance) { StartCoroutine(playerDidGetLucky()); }
            }
        ...
        if (EnterText.choseTails == 1)
        {
            ...
            if (Challenges.completedChallenge2 == 1 || Challenges.completedChallenge3 == 1)
            {
                if (random > MainButtonClick.lowSpecialChance) { StartCoroutine(ChoseTailsHitTails()); }
                if (random <= MainButtonClick.lowSpecialChance) { StartCoroutine(playerDidGetLucky()); }
            }
    ...
    IEnumerator CreatePopUpHeads()
    {
        ...
        popUpHeadsCopy.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.heads + "+" + FormatCoins(MainButtonClick.coinsPerClick * (2 + AscendScreen.specialFlipperCoinMultiplier + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus));
        ...
        GlobalCoins.CoinCount += MainButtonClick.coinsPerClick *(2 + AscendScreen.specialFlipperCoinMultiplier + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus);
        CreatingCoin = false;
    ...
    IEnumerator ChoseTailsHitTails()
    {
        ...
        popUpHeadsTails.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.tails + "+" + FormatCoins(MainButtonClick.coinsPerClick * (2 + AscendScreen.specialFlipperCoinMultiplier + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus + ManualClicking.flipAllBonus));
    ...
    IEnumerator playerDidGetLucky()
    {
        ...
        luckyPopUpCopy.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = LocalizationStrings.luckyCoin + "+" + FormatCoins((MainButtonClick.coinsPerClick * (1 + AscendScreen.specialFlipperCoinLuckyMultiplier + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus)) * 10);
        ...
        GlobalCoins.CoinCount += (MainButtonClick.coinsPerClick * (1 + AscendScreen.specialFlipperCoinLuckyMultiplier + Challenges.chall3Bonus + MainButtonClick.chall3CompletedBonus)) * 10;
