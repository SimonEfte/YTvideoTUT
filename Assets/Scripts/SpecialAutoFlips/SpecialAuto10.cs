...
public class SpecialAuto10 : MonoBehaviour
{
    ...
    public GameObject coverOver10;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim10.GetComponent<GoldenFlipsButton>();
        coverOver10.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim10.Play(); }
        else { newFlipScript.FlipSpecial(10); }
