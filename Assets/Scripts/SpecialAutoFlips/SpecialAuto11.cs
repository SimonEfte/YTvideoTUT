...
public class SpecialAuto11 : MonoBehaviour
{
    ...
    public GameObject coverOver11;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim11.GetComponent<GoldenFlipsButton>();
        coverOver11.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) {   specialAnim11.Play(); }
        else { newFlipScript.FlipSpecial(11); }
