...
public class SpecialAuto12 : MonoBehaviour
{
    ...
    public GameObject coverOver12;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim12.GetComponent<GoldenFlipsButton>();
        coverOver12.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim12.Play(); }
        else { newFlipScript.FlipSpecial(12); }
