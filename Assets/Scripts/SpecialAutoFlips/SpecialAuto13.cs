...
public class SpecialAuto13 : MonoBehaviour
{
    ...
    public GameObject coverOver13;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim13.GetComponent<GoldenFlipsButton>();
        coverOver13.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim13.Play(); }
        else { newFlipScript.FlipSpecial(13); }
