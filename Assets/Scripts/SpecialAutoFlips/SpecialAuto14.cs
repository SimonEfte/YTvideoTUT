...
public class SpecialAuto14 : MonoBehaviour
{
    ...
    public GameObject coverOver14;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim14.GetComponent<GoldenFlipsButton>();
        coverOver14.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim14.Play(); }
        else { newFlipScript.FlipSpecial(14); }
