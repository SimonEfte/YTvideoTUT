...
public class SpecialAuto16 : MonoBehaviour
{
    ...
    public GameObject coverOver16;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim16.GetComponent<GoldenFlipsButton>();
        coverOver16.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim16.Play(); }
        else { newFlipScript.FlipSpecial(16); }
