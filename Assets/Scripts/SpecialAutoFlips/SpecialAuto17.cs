...
public class SpecialAuto17 : MonoBehaviour
{
    ...
    public GameObject coverOver17;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim17.GetComponent<GoldenFlipsButton>();
        coverOver17.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim17.Play(); }
        else { newFlipScript.FlipSpecial(17); }
