...
public class SpecialAuto18 : MonoBehaviour
{
    ...
    public GameObject coverOver18;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim18.GetComponent<GoldenFlipsButton>();
        coverOver18.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim18.Play(); }
        else { newFlipScript.FlipSpecial(18); }
