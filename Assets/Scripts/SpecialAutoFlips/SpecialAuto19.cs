...
public class SpecialAuto19 : MonoBehaviour
{
    ...
    public GameObject coverOver19;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim19.GetComponent<GoldenFlipsButton>();
        coverOver19.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim19.Play(); }
        else { newFlipScript.FlipSpecial(19); }
