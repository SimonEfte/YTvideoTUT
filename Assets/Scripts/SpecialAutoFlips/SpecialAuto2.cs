...
public class SpecialAuto2 : MonoBehaviour
{
    ...
    public GameObject coverOver2;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim2.GetComponent<GoldenFlipsButton>();
        coverOver2.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim2.Play(); }
        else { newFlipScript.FlipSpecial(2); }
