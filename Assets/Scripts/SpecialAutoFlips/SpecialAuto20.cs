...
public class SpecialAuto20 : MonoBehaviour
{
    ...
    public GameObject coverOver20;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim20.GetComponent<GoldenFlipsButton>();
        coverOver20.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim20.Play(); }
        else { newFlipScript.FlipSpecial(20); }
