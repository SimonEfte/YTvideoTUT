...
public class SpecialAuto21 : MonoBehaviour
{
    ...
    public GameObject coverOver21;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim21.GetComponent<GoldenFlipsButton>();
        coverOver21.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim21.Play(); }
        else { newFlipScript.FlipSpecial(21); }
