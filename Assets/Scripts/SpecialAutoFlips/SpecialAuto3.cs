...
public class SpecialAuto3 : MonoBehaviour
{
    ...
    public GameObject coverOver3;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim3.GetComponent<GoldenFlipsButton>();
        coverOver3.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim3.Play(); }
        else { newFlipScript.FlipSpecial(3); }
