...
public class SpecialAuto4 : MonoBehaviour
{
    ...
    public GameObject coverOver4;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim4.GetComponent<GoldenFlipsButton>();
        coverOver4.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim4.Play(); }
        else { newFlipScript.FlipSpecial(4); }
