...
public class SpecialAuto5 : MonoBehaviour
{
    ...
    public GameObject coverOver5;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim5.GetComponent<GoldenFlipsButton>();
        coverOver5.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim5.Play(); }
        else { newFlipScript.FlipSpecial(5); }
