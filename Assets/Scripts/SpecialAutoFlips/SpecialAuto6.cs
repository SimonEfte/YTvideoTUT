...
public class SpecialAuto6 : MonoBehaviour
{
    ...
    public GameObject coverOver6;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim6.GetComponent<GoldenFlipsButton>();
        coverOver6.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim6.Play(); }
        else { newFlipScript.FlipSpecial(6); }
