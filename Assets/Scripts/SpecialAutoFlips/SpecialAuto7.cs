...
public class SpecialAuto7 : MonoBehaviour
{
    ...
    public GameObject coverOver7;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim7.GetComponent<GoldenFlipsButton>();
        coverOver7.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim7.Play(); }
        else { newFlipScript.FlipSpecial(7); }
