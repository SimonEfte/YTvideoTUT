...
public class SpecialAuto8 : MonoBehaviour
{
    ...
    public void Awake()
    {
        goldenFlip = specialAnim8.GetComponent<GoldenFlipsButton>();
    ...
    public void CreateTheCoin()
    {
        ...
        if (LoadSaves.isMobileBuild == false) { specialAnim8.Play(); }
        else { newFlipScript.FlipSpecial(8); }
