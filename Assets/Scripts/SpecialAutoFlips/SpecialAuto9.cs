...
public class SpecialAuto9 : MonoBehaviour
{
    ...
    public GameObject coverOver9;
    public TestingNewAnim newFlipScript;

    public void Awake()
    {
        goldenFlip = specialAnim9.GetComponent<GoldenFlipsButton>();
        coverOver9.SetActive(false);
    }
    ...
    {
        if (LoadSaves.isMobileBuild == false) { specialAnim9.Play(); }
        else { newFlipScript.FlipSpecial(9); }
